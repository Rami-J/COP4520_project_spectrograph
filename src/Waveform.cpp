...
void Waveform::initialize(const QAudioFormat& format, qint64 audioBufferSize, qint64 windowDurationUs)
{
    ...
    m_windowLength = Utils::audioLength(m_format, windowDurationUs);
...
void Waveform::paintTile(int index)
{
    ...
    const qreal previousRealValue = Utils::pcmToReal(previousPcmValue);
    ...
    for (int i = 0; i < numSamples; ++i) {
        ...
        const qreal realValue = Utils::pcmToReal(pcmValue);
