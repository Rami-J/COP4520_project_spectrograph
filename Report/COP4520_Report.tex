...
\section{State-of-the-Art Research}
	...
	\par {
		...
		% Should I delve more into the specifics that are coverd by the \cite{Pan}?
	}
	...
	\subsection{Radix 2 Decimation in Time}
		...
		\par{
			A parallel implementation of the RAD2 DIT algorithm that proposes splitting the number of threads 
	...
	\subsection{Split Radix FFT}
		\par{
			...
			as opposed to the Radix 2 DIT's ${5n Log(n)}$ \cite{Soni}.
		}
